...
export default class extends React.Component {
  ...
  render () {
    ...
    return (
      <View>
        <View style={{height: adaptiveStatusBar && this.props.statusbarPadding ? STATUS_BAR_HEIGHT : 0, backgroundColor: this.props.barTintColor}}/>
        <View style={
          [styles.navbar,
            {
        ...
        onLayout={() => Platform.OS === 'ios' && StatusBarManager.getHeight(result => this.setState({adaptiveStatusBar: result.height > 0}))}
        >
          {
